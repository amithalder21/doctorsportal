  ...
  return `
    <div style="${baseStyles}">
      <div style="${headerStyles}">
        <h1 style="color: #132573; margin: 0;">Priya Sharma Clinic</h1>
      </div>
      <div style="font-size: 16px; line-height: 1.6;">
        ...
        <p style="margin-top: 30px;">Best Regards,<br/><strong>The Priya Sharma Clinic Team</strong></p>
      </div>
      <div style="${footerStyles}">
        <p>© ${new Date().getFullYear()} Priya Sharma Clinic. All rights reserved.</p>
      </div>
    </div>
  `;
};
...
export const getAppointmentCompletedEmail = (name: string, date: string) => {
  return `
    <div style="${baseStyles}">
      ...
      <div style="font-size: 16px; line-height: 1.6;">
        <p>Dear <strong>${name}</strong>,</p>
        <p>Thank you for visiting Priya Sharma Clinic on <strong>${date}</strong>. We hope you had a comfortable and satisfactory experience.</p>
        ...
        <p style="margin-top: 30px;">Best Regards,<br/><strong>Dr. Priya Sharma & The Priya Sharma Clinic Team</strong></p>
      </div>
      <div style="${footerStyles}">
        <p>© ${new Date().getFullYear()} Priya Sharma Clinic. All rights reserved.</p>
      </div>
  ...
  return `
    <div style="${baseStyles}">
      ...
      <div style="font-size: 16px; line-height: 1.6;">
        ...
        <p>Thank you for choosing Priya Sharma Clinic.</p>
