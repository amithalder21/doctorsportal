  ...
  return (
    <footer className="bg-salute-primary text-white py-16">
      <div className="container mx-auto px-6 grid md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3 mb-6">
            <h3 className="text-2xl font-bold text-white font-heading">Dr. Priya Sharma</h3>
          </div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center hover:bg-salute-secondary transition-colors group">
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><a href="#" className="text-white/70 hover:text-salute-secondary transition-colors">IVF & Infertility</a></li>
            <li><a href="#" className="text-white/70 hover:text-salute-secondary transition-colors">PCOS Management</a></li>
          </ul>
        </div>
      </div>
      <div className="container mx-auto px-6 mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between text-white/50 text-sm">
        <p>&copy; {new Date().getFullYear()} Dr. Priya Sharma. All rights reserved.</p>
