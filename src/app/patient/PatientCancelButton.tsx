...
export default function PatientCancelButton({ appointmentId, status }: { appointmentId: string, status: string }) {
  ...
  return (
    <button 
      ...
      className="mt-4 md:mt-0 px-4 py-2 text-sm font-bold text-red-600 bg-red-50 hover:bg-red-100 rounded-xl transition-colors disabled:opacity-50 inline-flex items-center gap-2"
    >
